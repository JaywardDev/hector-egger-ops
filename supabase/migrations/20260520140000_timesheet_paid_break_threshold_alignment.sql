...
begin
  ...
  if not p_is_public_holiday then
    ...
    -- Keep this threshold aligned with PAID_BREAK_THRESHOLD_HOURS in src/lib/timesheets/validation.ts.
    v_derived_paid_break := round((extract(epoch from (p_time_out - p_time_in)) / 3600)::numeric, 1) >= 2.5;
