...
export default async function ProductionReasonsPage({ searchParams }: Props) {
  ...
  if (!roles.includes("admin")) return <PageContainer><PageHeader title="Production reasons" description="Admin access is required for reason management." /></PageContainer>;
